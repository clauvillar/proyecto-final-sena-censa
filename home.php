...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="1000">
            <img src="./img/carrusel2.jpg" height="600px" class="d-block w-100 opacity-10" alt="..." />
        ...
        <div class="carousel-item" data-bs-interval="10000">
            <img src="./img/carrusel1.jpg" height="600px" class="d-block w-100 opacity-50" alt="..." />
        ...
        <div class="carousel-item">
            <img src="./img/carrusel.jpg" height="600px" class="d-block w-100 opacity-50" alt="..." />
            <div class="container-text">
                <div class="carousel-caption d-none d-md-block">
...
<div class="featurette" id="nosotros">
    <div class="row featurette">
      <div class="col-md-7">
        <h1 class="featurette-heading">Nosotros</h1>
        <p class="lead"> <br>Una compañía de tecnología estratégica que busca potenciar las habilidades de las empresas, partiendo del desarrollo eficiente con un equipo de profesionales que se han desempeñados en
        diversos ámbitos como son la consultoría informática en empresas y el desarrollo de software, enfocado en brindar asesoría y recursos especializados en las plataformas tecnológicas acorde a las necesidades de nuestros clientes.
        Nuestra rica experiencia nos permite hablar el mismo idioma con nuestros clientes y entender sus necesidades fácil y rápidamente. Nuestro conocimiento se extiende desde el diseño creativo web, pasando por el diseño de aplicaciones, desarrollo e integración de sistemas, hasta el control de procesos clave en la operativa de un determinado negocio.
                         </p>
      </div>
         <div class="col-md-5">
             <img src="img/nosotros1.jpg" width="500" height="500"></img>
        </div>
    </div>
</div>
